...
void main()
{
	...
	while (zero != 0)
	{
		printf(" Выберите один из пунктов ниже и введите его цифру в консоль. \n \n ");
		printf(" Меню \n 1. Ввести массив вручную \n 2. Вывести массив на экран \n 3. Выбрать количество эллементов в массиве. Сейчас n= %d", N);
		printf(" \n 4. Заполнить массив рандомными элементами \n 5. Отсортировать массив сортировкой пузырьком. \n 6. Отсортировать массив сортировкой расческой \n ");
		printf("7. Отсортировать массив поразрядной сортировкой. \n 8. Отсортировать массив сортировкой слиянием \n 0. Выход\n");
		scanf("%d", &zero);
		if (zero == 1)
		{
			for (i = 0; i < N; i++)
		...
		if (zero == 5)
		{
			...
			printf("Число перестановок %" PRId64 "\n", flow.swapCount);
			printf("Число сравнений %" PRId64 "\n", flow.compareCount);
		}
		if (zero == 6)
		{
			flow = comb_sort(p, N);
